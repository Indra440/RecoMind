...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // Get user info from localStorage (UI simulation)
      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Here's what's happening with your AI recommendation system today.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900">New recommendations generated</p>
              ...
              <div className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900">Conversion rate improved by 5%</p>
              ...
              <div className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900">New business profile added</p>
              ...
              <div className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900">Monthly report available</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              {/* <Link 
                ...
                className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-200 group"
              >
                <div className="flex items-center space-x-3">
              ...
              <button className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-all duration-200 group w-full">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-semibold text-gray-900">View Analytics Report</span>
                </div>
