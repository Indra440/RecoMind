...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate setting authentication (in real app, would use context/state management)
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2 group">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40 transition-all duration-300 group-hover:scale-110">
        ...
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              type="submit" 
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center px-4 py-2.5 bg-gray-900/50 border border-gray-700 rounded-xl hover:bg-gray-900/80 hover:border-gray-600 transition-all duration-200"
            >
